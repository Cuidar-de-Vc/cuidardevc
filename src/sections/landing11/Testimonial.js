          ...
          <Row className="align-items-center justify-content-around">
            <Col lg="4" md="6" sm="9" className="mb-16">
              <div className="single-testimonial text-center h-100 d-flex flex-column px-5">
                ...
                <p className="review-text mb-0 gr-text-6 fw-bold gr-text-color">
                ...
                <div className="user-block media pt-9 pt-lg-12 d-flex justify-content-center mt-auto">
                  <div className="user-image circle-md me-7">
                    <img className="w-100" src={imgT1} alt="" />
                  </div>
                  <div className="user-text text-start align-self-center">
                    <h4 className="user-title gr-text-9 heading-color mb-0 ">Ilya Vasin</h4>
                    <span className="user-rank gr-text-11 gr-text-color-opacity text-color-opacity">
                      Software Engineer
                    </span>
                  </div>
                </div>
            ...
            <Col lg="4" md="6" sm="9" className="mb-16">
              <div className="single-testimonial text-center h-100 d-flex flex-column px-5">
                ...
                <div className="user-block media pt-9 pt-lg-12 d-flex justify-content-center mt-auto">
                  ...
                  <div className="user-text text-start align-self-center">
                    <h4 className="user-title gr-text-9 heading-color mb-0">
                      Mariano Rasgado
                    </h4>
                    <span className="user-rank gr-text-11 gr-text-color-opacity text-color-opacity">
                      Software Engineer
            ...
            <Col lg="4" md="6" sm="9" className="mb-16">
              <div className="single-testimonial text-center h-100 d-flex flex-column px-5">
                ...
                <div className="user-block media pt-9 pt-lg-12 d-flex justify-content-center mt-auto">
                  ...
                  <div className="user-text text-start align-self-center">
                    <h4 className="user-title gr-text-9 heading-color mb-0">Oka Tomoaki</h4>
                    <span className="user-rank gr-text-11 gr-text-color-opacity text-color-opacity">
                      Software Engineer
                    </span>
                  </div>
