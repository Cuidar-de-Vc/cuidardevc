        ...
        <Row className="justify-content-center">
          <Col lg="4" md="6" sm="6" className="mb-9 mb-lg-0">
            <div className="single-fact text-center px-xl-6">
              <h3 className="title heading-color mb-7 gr-text-3">1M+</h3>
              <p className="gr-text-8 mb-0 text-color-opacity px-xl-3">
          ...
          <Col lg="4" md="6" sm="6" className="mb-9 mb-lg-0">
            <div className="single-fact text-center px-xl-6">
              <h3 className="title heading-color mb-7 gr-text-3">
                <LazyLoad>
          ...
          <Col lg="4" md="6" sm="6" className="mb-9 mb-lg-0">
            <div className="single-fact text-center px-xl-6">
              ...
              <p className="gr-text-8 mb-0 text-color-opacity px-xl-6">
