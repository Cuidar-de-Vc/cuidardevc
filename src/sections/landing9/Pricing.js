          ...
          <Row className="align-items-center justify-content-center">
            <Col xl="6" lg="7" md="8">
              <div className="section-title text-center mb-15 mb-lg-19">
                <h2 className="title gr-text-3 mb-7 heading-color">Get your airpod now.</h2>
                <p className="gr-text-8 mb-0 px-11 text-color-opacity">
          ...
          <Row className="justify-content-center">
            <Col sm="9" md="6" lg="4" className="mb-12 mb-lg-0">
              <div className="single-product d-flex flex-column px-7 text-center">
                ...
                <h4 className="gr-text-7 heading-color mb-6">Midnight Green</h4>
            ...
            <Col sm="9" md="6" lg="4" className="mb-12 mb-lg-0">
              <div className="single-product d-flex flex-column px-7 text-center">
                ...
                <h4 className="gr-text-7 heading-color mb-6">Silver</h4>
                <p className="gr-text-9 text-color-opacity mb-9">
                  AirPods (2nd gen) iPhone Colors with Wireless Charging Case
                </p>
                <Button className="gr-hover-y gr-text-11 mw-75 mx-auto">
            ...
            <Col sm="9" md="6" lg="4" className="mb-12 mb-lg-0">
              <div className="single-product d-flex flex-column px-7 text-center">
                ...
                <h4 className="gr-text-7 heading-color mb-6">Gold</h4>
                <p className="gr-text-9 text-color-opacity mb-9">
                  AirPods (2nd gen) iPhone Colors with Wireless Charging Case
                </p>
                <Button className="gr-hover-y gr-text-11 mw-75 mx-auto">
