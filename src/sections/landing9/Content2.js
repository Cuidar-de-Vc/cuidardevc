        ...
        <Container>
          <Row className="align-items-center justify-content-md-center">
            <Col sm="10" lg="5" className="order-lg-2 position-static">
              <div className="content-img position-relative gr-abs-lg gr-abs-lg-ry-center w-lg-50 text-center text-lg-end">
              ...
              <Row>
                <Col lg="10" xl="9">
                  ...
                  <div className="testimonial-wrapper mt-6 mt-md-0">
                    ...
                    >
                      <div className="media-icon me-8">
                        <img className=" circle-sm-2" src={imgT} alt="" />
                      </div>
                      <div className="media-body">
                        <p className="gr-text-7 mb-0 pe-xl-6 gr-text-color mb-8 text-color-opacity">
