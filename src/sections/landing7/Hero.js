            ...
            <Row className="justify-content-sm-end">
              <Col lg="6" md="8">
                <div className="hero-content pe-xl-16 pt-18 pt-lg-31 pb-md-18 pb-lg-30 mb-9 mb-md-0">
                  <h6 className="gr-text-12 text-uppercase mb-8 text-white">
                    Not another zoom for you!
                  </h6>
                  <h1 className="title gr-text-2 mb-8 heading-color">Start. Join. Meet.</h1>
                  <p className="gr-text-8 mb-0 text-color-opacity">
                    With lots of unique blocks, you can easily build a page
                    without coding. Build your next consultancy website within
                    few minutes.
                  </p>
                  <Button variant="success" className=" mt-11 btn btn-success">
                    Start my meeting
                  </Button>
                </div>
              </Col>
