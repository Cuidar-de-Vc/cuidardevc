          ...
          <Row className="justify-content-center">
            <Col xl="5" lg="6" md="8">
              <div className="section-title text-center mb-13 mb-lg-21">
                <h2 className="title gr-text-4 mb-6 heading-color">How does it work?</h2>
          ...
          <Row className="align-items-center justify-content-center">
            ...
            >
              <div className="feature-widget text-center">
                ...
                <div className="widget-text">
                  <h3 className="title heading-color gr-text-6 mb-7">Get Appointment</h3>
            ...
            >
              <div className="feature-widget text-center">
                ...
                <div className="widget-text">
                  <h3 className="title heading-color gr-text-6 mb-7">Meet Your Doctor</h3>
                  <p className="gr-text-11 text-color-opacity mb-0">
                    We've made telemedicine simple and easy for you. Create your
                    personal room and start practicing telemedicine today.
                  </p>
            ...
            >
              <div className="feature-widget text-center">
                ...
                <div className="widget-text">
                  <h3 className="title heading-color gr-text-6 mb-7">Get Better Treatment</h3>
                  <p className="gr-text-11 text-color-opacity mb-0">
                    We've made telemedicine simple and easy for you. Create your
                    personal room and start practicing telemedicine today.
                  </p>
