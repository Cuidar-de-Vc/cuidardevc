        ...
        <Container id="animation-area-1">
          <Row className="align-items-center justify-content-center">
            <Col
              ...
              md="7"
              lg="5"
              className="offset-xl-1 align-self-sm-end order-lg-2 p-relative"
            >
              <div
              ...
              <div className="hero-sm-card-1">
                ...
                >
                  ...
                  <div className="small-card-img ms-6">
              ...
              <div className="animation-item">
                <div
                  ...
                  id="an-item-1p2"
                >
                  <div className="small-card-img me-6 text-white">
            ...
            <Col
              ...
              data-aos-delay="500"
            >
              <div className="hero-content section-title text-center text-lg-start">
                <h1 className="gr-text-2 fw-bold mb-8 heading-color">
                  Get treatment <br className="" />
                  from your home!
                </h1>
                <p className="gr-text-9 gr-text-color pe-md-7 text-color-opacity">
                ...
                >
                  <span className="me-2 gr-text-color circle-18 border border-black-dynamic">
                    <i className="icon icon-triangle-right-17-2 gr-text-14"></i>
                  </span>
                  <span className="gr-text-12 fw-bold text-uppercase">
