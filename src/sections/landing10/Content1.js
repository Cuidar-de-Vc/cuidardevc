      ...
      <div className="content-section pt-12 pb-10 bg-default-6 py-xl-25 ">
        <Container>
          <Row className="align-items-center justify-content-md-center">
            <Col lg="4" md="10">
              <div className="content-text text-center text-lg-start mb-9 mb-lg-0 pe-xl-11">
                <h2 className="title gr-text-5 mb-8 heading-color">
                  Experienced experts are giving advices.
                </h2>
                <p className="gr-text-8 mb-9 text-color-opacity">
            ...
            <Col lg="4" md="6">
              <div className="stats-wrapper mt-6 mt-md-0 ps-xl-9">
                <div
                  className="single-stat py-6"
                  data-aos="fade-left"
                  data-aos-duration="1000"
                >
                  <h3 className="title gr-text-5 heading-color mb-5">1M+</h3>
                ...
                >
                  <h3 className="title gr-text-5 heading-color mb-5">
                    <LazyLoad>
