        ...
        <Container>
          <Row className="justify-content-sm-end align-items-center">
            <Col
              ...
              data-aos-delay="500"
            >
              <div className="hero-content pe-xl-19 mb-9 mb-md-0">
                <h1 className="title gr-text-3 mb-6 heading-color">
                  Make your business powerful with Shade.
                </h1>
                <p className="gr-text-8 mb-8 text-color-opacity">
                ...
                >
                  <span className="d-inline-flex me-2 gr-text-color">
