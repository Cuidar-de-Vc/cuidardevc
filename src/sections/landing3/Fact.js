...
const Fact = () => (
  <>
    {/* <!-- Fact section --> */}
    <div className="fact-section bg-default-4 border-bottom-2 pt-13 pt-lg-18 pb-7 pb-lg-17 ">
      <Container>
        <Row className="justify-content-center">
          <Col lg="4" md="6" sm="6" className="mb-9 mb-lg-0">
            <div className="single-fact text-center px-md-9 px-lg-6 px-xl-11">
              <h3 className="title heading-color mb-7 gr-text-3 counter">
                <LazyLoad>
                  <CountUp duration={9} end={6} />
                </LazyLoad>
              </h3>
              <p className="gr-text-8 mb-0 text-color-opacity px-xl-4">
