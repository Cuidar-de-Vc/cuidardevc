          ...
          <Row className="align-items-center justify-content-center">
            <Col md="10" lg="6" xl="5">
              <div className="section-title content-text mb-13 mb-lg-16">
                <h2 className="title text-white gr-text-3 mb-6">
                ...
                <Row>
                  ...
                  >
                    <div className="single-widget media mb-9 mb-lg-12">
                      <div className="widget-icon circle-30 bg-green me-7">
                        <i className="icon icon-check-2-2 text-white"></i>
                      </div>
                      <div className="widget-text">
                        <h3 className="w-title gr-text-7 text-white">
                          Noise Free Locations
                        </h3>
                        <p className="gr-text-9 mb-0 text-white">
                  ...
                  >
                    <div className="single-widget media mb-9 mb-lg-0">
                      ...
                      <div className="widget-text">
                        <h3 className="w-title text-white gr-text-7">24/7 Hour Support</h3>
                        <p className="gr-text-9 text-white mb-0">
                          With lots of unique blocks, you can easily build a
                          page without coding.{" "}
                        </p>
                      </div>
            ...
            >
              <div
                className="accordion ps-9 pe-8 rounded-10 bg-white border-green border-top-5"
                id="accordionExample"
              >
                ...
                <div className="border-bottom overflow-hidden">
                  <div className="mb-0 border-bottom-0" id="heading2-2">
                    ...
                    >
                      Can I use Cuidar de Você for my clients?
                    </button>
                  </div>
