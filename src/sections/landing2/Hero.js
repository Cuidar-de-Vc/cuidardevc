      ...
      <Container>
        <Row className="justify-content-sm-end">
          <Col lg="6" md="8" className="py-md-16 py-lg-20 z-index-99">
            <div className="hero-content pe-xl-16 mb-9 mb-md-12">
              <h1 className="title heading-color gr-text-2 mb-8">
            ...
            <div className="search-box bg-green shadow-7 rounded-10 px-8 pt-7 pb-7 me-lg-n34 me-xl-n33">
            ...
            <p className="gr-text-11 mb-0 mt-6 text-color-opacity">
