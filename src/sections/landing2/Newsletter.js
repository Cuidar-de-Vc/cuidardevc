        ...
        <Row className="justify-content-center">
          <Col md="8" lg="7" xl="6">
            <div className="section-title text-center mb-11">
              ...
              <h2 className="title gr-text-4 mb-7 heading-color">Get our latest updates</h2>
            ...
            <div className="subscribe-form mb-8">
              <form action="./">
                <div className="form-group position-relative">
                  <input
                    className="form-control gr-text-9 border mb-6 min-height-px-64 bg-white"
                    type="email"
                    id="email"
                    placeholder="Enter your email"
                  />
                  <button className="form-btn btn btn-primary me-2 gr-abs-md-cr min-height-px-50 w-100 w-md-auto">
                    Subscribe
                  </button>
                </div>
              </form>
