          ...
          <Container>
            <Row className="justify-content-center">
              <Col lg="4" md="6" sm="8" className="mb-9">
                <div className="pricing-card gr-hover-shadow-1 bg-white border rounded-10 text-center pt-9 pb-6 pe-6 ps-6">
                  <span className="badge gr-badge text-primary gr-bg-blue-opacity-1 rounded-pill gr-text-12 text-uppercase">
                    Basic
                  </span>
                  <h2 className="price-value gr-text-3 fw-bold text-blackish-blue line-spacing-none mb-2 mt-8">
                    $29
                  </h2>
                  <p className="gr-text-11 mb-7 mb-lg-11 gr-color-blackish-blue-opacity-7 text-color-opacity">
                    One time purchase
                  </p>
                  <p className="gr-text-9 text-color-opacity px-5 gr-color-blackish-blue-opacity-7 text-color-opacity mb-0">
                    With lots of unique blocks, you can easily build a page
                    without coding. Build your next landing page.
                  </p>
                  <Button className="gr-hover-y w-100 mt-9 mt-lg-15 gr-text-9 text-color-opacity">
            ...
            <Row className="justify-content-center">
              <Col xl="6" lg="6" className="pb-9 pb-lg-15">
                <div className="faq d-flex">
                  <div className="faq-icon mt-1 circle-xs bg-green text-white me-5 me-sm-7">
                    <i className="fas fa-question"></i>
                  </div>
                  <div className="faq-texts pr-md-7 pr-lg-0 pr-xl-7">
                    <h3 className="gr-text-7 heading-color fw-bold mb-7">
                    ...
                    <Link
                      to="/#"
                      className="btn-link with-icon fw-bold gr-text-9 mt-9"
                    >
                      Click to learn more{" "}
                      <i className="fas fa-arrow-right fw-bold"></i>
                    </Link>
                  </div>
                </div>
              </Col>
              ...
              <div className="col-12 text-center mt-lg-9 ">
                <p className="gr-text-9 text-color-opacity gr-text-9 text-color-opacity gr-text-color mb-0">
