        ...
        <div className="pricing-section bg-default-2 pt-lg-9 pb-5 pb-md-19">
          <Container>
            <Row className="justify-content-center">
              ...
              >
                <div className="pricing-card gr-hover-shadow-1 text-center pt-9 pb-9 pe-9 pe-xl-9 ps-9 ps-xl-9 bg-white rounded-10">
                  <div className="price-content light-mode-texts">
                    ...
                    <div className="d-flex align-items-end justify-content-center mt-9 ">
                      ...
                      <h2 className="price-value gr-text-2 text-blackish-blue fw-bold line-spacing-none mb-0">
                        19
                      </h2>
              ...
              >
                <div className="pricing-card gr-hover-shadow-1 text-center pt-9 pb-9 pe-9 pe-xl-9  ps-9 ps-xl-9 bg-white rounded-10">
                  ...
                  <Button variant="danger" className="gr-hover-y w-100 mx-auto text-white btn-red">
                    Get Started Now
                  </Button>
                </div>
              </Col>
              <Col
                ...
                className="col-lg-4 col-md-6 col-sm-8 mb-9"
              >
                <div className="pricing-card h-100 gr-hover-shadow-1 text-center pt-9 pb-9 pe-9 pe-xl-9 ps-9 ps-xl-9 bg-blue rounded-10 dark-mode-texts d-lg-flex flex-column">
                  <div className="price-content">
                    <span className="small-title gr-text-12 text-uppercase text-red fw-bold text-gray-2 pb-9 d-block">
                      Enterprise
                    </span>
                    <p className="gr-text-9 gr-color-white-opacity-6 px-xl-4">
                  ...
                  <Button
                    variant="success"
                    className="gr-hover-y gr-min-width-219 text-white mx-auto mt-auto btn-green"
                  >
                    Contact Sales
                  </Button>
                </div>
          ...
          <Container>
            ...
            <Row className="justify-content-center">
              <Col xl="8" lg="9">
                <div className="accordion" id="accordionExample">
                  <div className="border rounded-10 mb-3 bg-white overflow-hidden">
                    <div
                      className="mb-0 py-8 ps-9 pe-7 border-bottom-0 bg-white"
                      id="heading4-1"
                    >
                      <button
                        className="btn-reset gr-text-7 fw-bold text-left text-blackish-blue p-0 accordion-trigger arrow-icon w-100"
                        type="button"
                    ...
                    <Collapse in={openItem === 1}>
                      <div>
                        <div className="card-body gr-color-blackish-blue-opacity-7 pt-0 ps-9 pe-15 gr-text-9 pb-9">
              ...
              <div className="col-12 text-center pt-11">
                <p className="gr-text-9 gr-text-9 gr-text-color heading-color">
