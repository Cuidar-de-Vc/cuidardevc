...
const CartItem = ({ qty, price, img, title, handleRemove }) => {
  return (
    <>
      <li className="mb-5">
        <div className="d-flex position-relative p-6 border-gray-3 rounded-10 pe-12">
          <div className="square-50 me-6">
            <img
              src={img}
              alt=""
              css={`
          ...
          <div>
            ...
            <div className="bottom-texts d-flex justify-content-between">
              <span className="inline-block gr-text-12 fw-bold text-uppercase text-blackish-blue">
                {qty} items
              </span>
              <span className="inline-block gr-text-12 fw-bold text-bold text-blackish-blue">
                ${qty * price}
              </span>
            </div>
          </div>
          <a
            ...
            className="cross-btn gr-abs-cr me-7 text-blackish-blue gr-text-8"
          >
            ...
            <Row className="justify-content-center pt-5">
              <Col xl="8" lg="9">
                <div className="px-md-15 text-center">
                  <h2 className="title gr-text-2 mb-9 heading-color">Checkout</h2>
            ...
            <Row className="justify-content-md-between pt-9">
              <Col lg="7" xl="7">
                <div className="login-form bg-white border-gray-3 px-md-12 px-7 pt-12 pb-13 shadow-1 rounded-10 mb-9">
                  <h3 className="gr-text-7 fw-bold mb-8 text-blackish-blue">
                    Billing Details
                  </h3>
                  <form action="./">
                    <Row>
                      <Col xs="12">
                        <div className="form-group mb-7">
                          ...
                          <input
                            className="form-control gr-text-11 border-gray-3 px-4 mt-3 bg-white
                            "
                            type="text"
                            id="name"
                      ...
                      <Col xs="12" className="mb-6">
                        ...
                        <div className="form-group mb-7 gr-radio-input d-flex align-items-center w-100 border-gray-3 rounded-5 pt-5 pb-5 px-6">
                          <input
                            ...
                            name="payment"
                            id="credit-card"
                            className="invisible position-absolute pointer-none mt-3 bg-white"
                          />
                          <label
                            htmlFor="credit-card"
                            className="d-flex align-items-center mb-0 w-100"
                          >
                            <span className="round-indicator me-3"></span>
                            <span className="line-height-reset fw-bold gr-text-11 text-blackish-blue">
                              Credit Cards{" "}
                            </span>
                            <img
                              src={imgCC}
                      ...
                      <Col xs="12" className="mb-7">
                        <div className="form-group mb-0">
                          ...
                          <div className="position-relative">
                            <input
                              className="form-control gr-text-11 border-gray-3 pr-15 mt-3 bg-white"
                              type="number"
                              id="card"
                              placeholder="11154 5665 6464 565"
                            />
                            <div className="gr-abs-tr h-100 d-flex align-items-center me-5">
                              <img src={imgV} alt="" />
                            </div>
                          </div>
                        </div>
                      ...
                      <Col md="6" className="pb-9">
                        <div className="form-group mb-0">
                          ...
                          <div className="position-relative">
                            <input
                              className="form-control gr-text-11 border-gray-3 pe-9 mt-3 bg-white"
                              type="text"
                              id="code"
                              placeholder="PIN"
                            />
                            <i className="far fa-question-circle gr-abs-cr me-6 "></i>
                          </div>
                        </div>
                      </Col>
                      ...
                      <Col xs="12">
                        <div className="form-group mb-8 gr-radio-input d-flex align-items-center w-100 border-gray-3 rounded-5 pt-5 pb-5 px-6">
                          <input
                            ...
                            name="payment"
                            id="paypal"
                            className="invisible position-absolute pointer-none mt-2 bg-white"
                          />
                          <label
                            htmlFor="paypal"
                            className="d-flex align-items-center mb-0 w-100"
                          >
                            ...
                            <img src={imgP} alt="" className="ms-auto" />
                          </label>
                        </div>
                      </Col>
              ...
              <Col sm="7" md="7" lg="5">
                <div className="bg-white px-7 pt-8 pb-9 rounded-10 ml-lg-8  ms-xl-10 mt-9 mt-md-0">
                  <h3 className="gr-text-12 fw-bold text-blackish-blue text-uppercase pb-7">
                    Order Details
                  </h3>
                    ...
                    <li className="d-flex justify-content-between mb-5">
                      ...
                      <div className="d-flex gr-text-9">
                        <span className="d-inline-flex  ps-7 pt-5  position-relative me-2">
                          <span className="border-0 p-0 w-100 h-100 gr-abs-tl gr-text-9 text-color-opacity-2  gr-text-opacity focus-reset pointer-none text-blackish-blue-opacity">
