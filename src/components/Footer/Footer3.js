        ...
        <Container>
          <div className="footer-top pb-lg-14">
            <Row>
              ...
              <Col xs="6" lg="3">
                <div className="single-footer mb-13 mb-lg-9">
                  <p className="footer-title gr-text-11 text-color-opacity mb-7 text-color-opacity">Legal</p>
                  <ul className="footer-list list-unstyled">
                    <li className="py-2">
                      <Link
                        to="/#"
              ...
              <Col xs="6" lg="3" className="offset-lg-2">
                <div className="single-footer mb-13 mb-lg-9">
                  <div className="download-block">
                    <p className="download-title gr-text-11 text-color-opacity mb-9">
                      Download Our App
                    </p>
            ...
            <Row className="align-items-center">
              <Col lg="6">
                <p className="copyright-text gr-text-11 text-color-opacity mb-6 mb-lg-0 gr-text-color text-center text-lg-start">
                  ...
                  <i className="icon icon-heart-2-2 text-red align-middle ms-2"></i>
                </p>
              </Col>
